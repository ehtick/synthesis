...
namespace Synthesis.Physics {
    ...
    public static class PhysicsHandler {
        ...
        public static bool InstanceExists()
            => NativePhysics.Physics_Instance_Exists();
        public static void CreateInstance(bool forceNew) {
            NativePhysics.Physics_Create_Instance(forceNew);
        }

        public static void DeleteInstance() {
            NativePhysics.Physics_Delete_Instance();
        }
        ...
        public static BtRayHitClosest RayCastClosest(BtVec3 from, BtVec3 to)
            => NativePhysics.Physics_Ray_Cast_Closest(from, to);

        public static BtVec3 GetWorldGravity()
            => NativePhysics.Get_World_Gravity();
        public static void SetWorldGravity(BtVec3 gravity) {
        ...
        public static unsafe VoidPointer CreateBoxShape(BtVec3 halfExtent)
        ...
        public static unsafe VoidPointer CreateConvexShape(BtVec3[] verts) {
        ...
        public static unsafe void DeleteCompoundCollisionShape(VoidPointer compoundShape) {
            NativePhysics.Delete_Compound_Collision_Shape(compoundShape.Pointer);
        }
        ...
        public static unsafe void AddShapeToCompoundShape(VoidPointer compound, VoidPointer shape, BtVec3 pos, BtQuat rot) {
        ...
        public static unsafe BtVec3 GetBoxShapeExtents(VoidPointer ptr)
        ...
        public static unsafe void ApplyForce(VoidPointer rigidbody, BtVec3 force, BtVec3 relativePosition) {
            NativePhysics.Apply_Force(rigidbody.Pointer, force, relativePosition);
        }

        // Getters
        public static unsafe BtVec3 GetRigidBodyLinearVelocity(VoidPointer rigidbody)
            => NativePhysics.Get_RigidBody_Linear_Velocity(rigidbody.Pointer);
        public static unsafe BtVec3 GetRigidBodyAngularVelocity(VoidPointer rigidbody)
            => NativePhysics.Get_RigidBody_Angular_Velocity(rigidbody.Pointer);
        public static unsafe BtVec3 GetRigidBodyPosition(VoidPointer rigidbody)
            => NativePhysics.Get_RigidBody_Position(rigidbody.Pointer);
        public static unsafe BtQuat GetRigidBodyRotation(VoidPointer rigidbody)
            => NativePhysics.Get_RigidBody_Rotation(rigidbody.Pointer);
        public static unsafe BtActivationState GetRigidBodyActivationState(VoidPointer rigidbody)
            => (BtActivationState)Enum.ToObject(typeof(BtActivationState), NativePhysics.Get_RigidBody_Activation_State(rigidbody.Pointer));
        ...
        // Setters
        public static unsafe void SetRigidBodyLinearVelocity(VoidPointer rigidbody, BtVec3 velocity) {
            NativePhysics.Set_RigidBody_Linear_Velocity(rigidbody.Pointer, velocity);
        }
        public static unsafe void SetRigidBodyAngularVelocity(VoidPointer rigidbody, BtVec3 ang_velocity) {
            NativePhysics.Set_RigidBody_Angular_Velocity(rigidbody.Pointer, ang_velocity);
        }
        public static unsafe void SetRigidBodyPosition(VoidPointer rigidbody, BtVec3 position) {
            NativePhysics.Set_RigidBody_Position(rigidbody.Pointer, position);
        }
        public static unsafe void SetRigidBodyRotation(VoidPointer rigidbody, BtQuat rotation) {
            NativePhysics.Set_RigidBody_Rotation(rigidbody.Pointer, rotation);
        }
        public static unsafe void SetRigidBodyActivationState(VoidPointer rigidbody, BtActivationState state) {
        ...
        public static unsafe VoidPointer CreateHingeConstraint(VoidPointer bodyA, VoidPointer bodyB,
            BtVec3 pivotA, BtVec3 pivotB, BtVec3 axisA, BtVec3 axisB, float lowLim, float highLim, bool internalCollision)
        ...
        internal static class NativePhysics {
            ...
            internal extern static unsafe bool Physics_Instance_Exists();
            [DllImport("BulletSynthesis.dll", CallingConvention = CallingConvention.Cdecl)]
            internal extern static unsafe void Physics_Create_Instance(bool forceNew);
            [DllImport("BulletSynthesis.dll", CallingConvention = CallingConvention.Cdecl)]
            internal extern static unsafe void Physics_Delete_Instance();
            [DllImport("BulletSynthesis.dll", CallingConvention = CallingConvention.Cdecl)]
            ...
            [DllImport("BulletSynthesis.dll", CallingConvention = CallingConvention.Cdecl)]
            internal extern static unsafe BtRayHitClosest Physics_Ray_Cast_Closest(BtVec3 from, BtVec3 to);
            [DllImport("BulletSynthesis.dll", CallingConvention = CallingConvention.Cdecl)]
            internal extern static unsafe BtVec3 Get_World_Gravity();
            [DllImport("BulletSynthesis.dll", CallingConvention = CallingConvention.Cdecl)]
            internal extern static unsafe void Set_World_Gravity(BtVec3 gravity);
            [DllImport("BulletSynthesis.dll", CallingConvention = CallingConvention.Cdecl)]
            ...
            [DllImport("BulletSynthesis.dll", CallingConvention = CallingConvention.Cdecl)]
            internal extern static unsafe void* Create_Box_Shape(BtVec3 halfSize);
            [DllImport("BulletSynthesis.dll", CallingConvention = CallingConvention.Cdecl)]
            ...
            [DllImport("BulletSynthesis.dll", CallingConvention = CallingConvention.Cdecl)]
            internal extern static unsafe void Delete_Compound_Collision_Shape(void* compoundShape);
            [DllImport("BulletSynthesis.dll", CallingConvention = CallingConvention.Cdecl)]
            ...
            [DllImport("BulletSynthesis.dll", CallingConvention = CallingConvention.Cdecl)]
            internal extern static unsafe void Add_Shape_To_Compound_Shape(void* compound, void* shape, BtVec3 pos, BtQuat rot);
            [DllImport("BulletSynthesis.dll", CallingConvention = CallingConvention.Cdecl)]
            internal extern static unsafe int Get_Compound_Shape_Child_Count(void* compound);
            [DllImport("BulletSynthesis.dll", CallingConvention = CallingConvention.Cdecl)]
            internal extern static unsafe BtVec3 Get_Box_Shape_Extents(void* shape);
            [DllImport("BulletSynthesis.dll", CallingConvention = CallingConvention.Cdecl)]
            ...
            [DllImport("BulletSynthesis.dll", CallingConvention = CallingConvention.Cdecl)]
            internal extern static unsafe void Apply_Force(void* rigidbody, BtVec3 force, BtVec3 relativePosition);
            [DllImport("BulletSynthesis.dll", CallingConvention = CallingConvention.Cdecl)]
            internal extern static unsafe BtVec3 Get_RigidBody_Linear_Velocity(void* rigidbody);
            [DllImport("BulletSynthesis.dll", CallingConvention = CallingConvention.Cdecl)]
            internal extern static unsafe void Set_RigidBody_Linear_Velocity(void* rigidbody, BtVec3 vel);
            [DllImport("BulletSynthesis.dll", CallingConvention = CallingConvention.Cdecl)]
            internal extern static unsafe BtVec3 Get_RigidBody_Angular_Velocity(void* rigidbody);
            [DllImport("BulletSynthesis.dll", CallingConvention = CallingConvention.Cdecl)]
            internal extern static unsafe void Set_RigidBody_Angular_Velocity(void* rigidbody, BtVec3 vel);
            [DllImport("BulletSynthesis.dll", CallingConvention = CallingConvention.Cdecl)]
            internal extern static unsafe BtQuat Get_RigidBody_Rotation(void* rigidbody);
            [DllImport("BulletSynthesis.dll", CallingConvention = CallingConvention.Cdecl)]
            internal extern static unsafe void Set_RigidBody_Rotation(void* rigidbody, BtQuat rotation);
            [DllImport("BulletSynthesis.dll", CallingConvention = CallingConvention.Cdecl)]
            internal extern static unsafe BtVec3 Get_RigidBody_Position(void* rigidbody);
            [DllImport("BulletSynthesis.dll", CallingConvention = CallingConvention.Cdecl)]
            internal extern static unsafe void Set_RigidBody_Position(void* rigidbody, BtVec3 pos);
            ...
            [DllImport("BulletSynthesis.dll", CallingConvention = CallingConvention.Cdecl)]
            internal extern static unsafe void* Create_Hinge_Constraint(void* bodyA, void* bodyB, BtVec3 pivotA,
                BtVec3 pivotB, BtVec3 axisA, BtVec3 axisB, float lowLim, float highLim, bool internalCollision);
            [DllImport("BulletSynthesis.dll", CallingConvention = CallingConvention.Cdecl)]
    ...
    [StructLayout(LayoutKind.Sequential)]
    public struct BtRayHitClosest {
        public bool hit;
        public BtVec3 hit_point;
        public BtVec3 hit_normal;
        public VoidPointer collision_object; // I think? This might not work
    }

    public enum BtActivationState {
        ACTIVE_TAG = 1,
        ISLAND_SLEEPING = 2,
